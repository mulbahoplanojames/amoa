...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    tr: ({ className, ...props }) => (
      <tr
        className={cn(
          "m-0 border-t border-primary/20 p-0 even:bg-muted",
          className
        )}
        {...props}
      />
    ...
    th: ({ className, ...props }) => (
      <th
        className={cn(
          "border border-primary/20 px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right",
          className
        )}
        {...props}
      />
    ...
    td: ({ className, ...props }) => (
      <td
        className={cn(
          "border border-primary/20 px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right",
          className
        )}
        {...props}
      />
